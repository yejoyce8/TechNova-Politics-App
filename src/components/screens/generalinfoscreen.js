...
import { Text, View, SafeAreaView, ScrollView, Button, Linking, ImageBackground } from 'react-native';
...
function GeneralInfoHome({navigation}){
    return(
        <SafeAreaView>
            <ScrollView>
                <ImageBackground style={{width:'100%', height: '100%'}} source={require("../../../assets/homepagebackground2.png")}>

                
                    <View>
                    <View style = {{alignItems: 'center'}}>
                    <Text style={{fontFamily: 'Avenir-Heavy', fontSize: 26, marginTop: 50}}> Elections Info </Text>
                    </View>
                
                    <View style = {{padding: 15,backgroundColor: "white", margin: 10, borderRadius: 10,  marginLeft: 40, marginRight: 40, marginTop: 30}}>
                    <Button title='Ways To Vote' onPress={() => navigation.navigate('Ways to Vote')}/>
                    
                    </View>

                    <View style = {{padding: 15,backgroundColor: "white", margin: 10, borderRadius: 10, marginLeft: 40, marginRight: 40}}>
                    ...
                    <View style = {{padding: 15,backgroundColor: "white", margin: 10, borderRadius: 10,  marginLeft: 40, marginRight: 40, marginBottom: 40}}>
...
function WaysToVoteScreen({navigation, route}){
    return(
        <SafeAreaView>
            <ScrollView>
            <View>
            <ImageBackground style={{width:'100%', height: '100%'}} source={require("../../../assets/homepagebackground1.png")}>

                <View style={{ backgroundColor: "white", margin: 10, borderRadius: 10, borderWidth: 2, borderStyle: 'dotted', borderColor: '#071A5D' }}>
